...
* @returns {string}
*/
export function run(times, people, penalities, bonus, table_length) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(people, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(penalities, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(bonus, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.run(retptr, times, ptr0, len0, ptr1, len1, ptr2, len2, table_length);
...
* @returns {string}
*/
export function rerun(times, population, penalities, bonus) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(population, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(penalities, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(bonus, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        wasm.rerun(retptr, times, ptr0, len0, ptr1, len1, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        return getStringFromWasm0(r0, r1);
    } finally {
...
async function load(module, imports) {
    if (typeof Response === 'function' && module instanceof Response) {
        if (typeof WebAssembly.instantiateStreaming === 'function') {
            try {
                module.headers.set('Content-Type', 'application/wasm');
...
function getImports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_logbest_3e88f41e62d60b4e = function(arg0, arg1, arg2) {
        try {
            log_best(getStringFromWasm0(arg0, arg1), arg2 >>> 0);
        } finally {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('sisters_wedding_bg.wasm', import.meta.url);
    }
    const imports = getImports();
